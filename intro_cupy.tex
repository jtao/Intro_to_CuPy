...
\textbf{ACES}: Accelerating Computing for Emerging Sciences, an \textbf{composable} computational prototype developed by Texas A\&M University.
\begin{center}
...
\begin{frame}
  \centering
  \vspace{0.4cm}
  {\Large \href{https://docs.google.com/forms/d/e/1FAIpQLSensgCZI15u9jwKR7wGL1c59BTojSJK3fwwKXHLLrONviKRFw/viewform}{HPRC Survey}}
  \vspace{0.2cm}
 \begin{center}
\includegraphics[width=0.3\textwidth]{images/hprc_survey.png}   
\end{center}
\end{frame}
